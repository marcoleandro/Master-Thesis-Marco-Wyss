...
CH_translated_business_merged_tidy <- CH_preparation_business_clean %>% select(X, ID, IdSession, Text, MeetingCouncilAbbreviation, MeetingDate, SpeakerFullName, SpeakerFunction, CantonName, ParlGroupName, LanguageOfText, Title, BusinessNumber)
...
# select random sample for reliability checks

...
boost_perf$dv <- factor(boost_perf$dv, levels = c("Grid Extension", "Substitution of Limited Resources", "Mitigation of Nuclear Risk", "Pollution Reduction", "Climate Change Mitigation", "Energy Democracy", "Employment", "Innovation", "Swiss Value Chain", "Competitiveness of Swiss Industry", "Costs of Electricity", "Avoidance of Dependencies", "Security of Electricity Supply", "Environmental Protection", "Energy Efficiency", "Nuclear Energy", "Geothermal Energy", "Biomass Energy", "Wind Energy", "Water Energy", "Solar Energy", "Renewable Energy (in general)"))
svm_perf$dv <- factor(svm_perf$dv, levels = c("Grid Extension", "Substitution of Limited Resources", "Mitigation of Nuclear Risk", "Pollution Reduction", "Climate Change Mitigation", "Energy Democracy", "Employment", "Innovation", "Swiss Value Chain", "Competitiveness of Swiss Industry", "Costs of Electricity", "Avoidance of Dependencies", "Security of Electricity Supply", "Environmental Protection", "Energy Efficiency", "Nuclear Energy", "Geothermal Energy", "Biomass Energy", "Wind Energy", "Water Energy", "Solar Energy", "Renewable Energy (in general)"))
forest_perf$dv <- factor(forest_perf$dv, levels = c("Grid Extension", "Substitution of Limited Resources", "Mitigation of Nuclear Risk", "Pollution Reduction", "Climate Change Mitigation", "Energy Democracy", "Employment", "Innovation", "Swiss Value Chain", "Competitiveness of Swiss Industry", "Costs of Electricity", "Avoidance of Dependencies", "Security of Electricity Supply", "Environmental Protection", "Energy Efficiency", "Nuclear Energy", "Geothermal Energy", "Biomass Energy", "Wind Energy", "Water Energy", "Solar Energy", "Renewable Energy (in general)"))
lasso_perf$dv <- factor(boost_perf$dv, levels = c("Grid Extension", "Substitution of Limited Resources", "Mitigation of Nuclear Risk", "Pollution Reduction", "Climate Change Mitigation", "Energy Democracy", "Employment", "Innovation", "Swiss Value Chain", "Competitiveness of Swiss Industry", "Costs of Electricity", "Avoidance of Dependencies", "Security of Electricity Supply", "Environmental Protection", "Energy Efficiency", "Nuclear Energy", "Geothermal Energy", "Biomass Energy", "Wind Energy", "Water Energy", "Solar Energy", "Renewable Energy (in general)"))
